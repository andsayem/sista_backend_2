...
<head>
  ...
  <title>{{ config('app.name','Web Sista')}}</title>
  ...
  <link rel="stylesheet" href="{{ asset('public/vendors/plugins/datatables-responsive/css/responsive.bootstrap4.min.css') }}">
  <link rel="stylesheet" href="{{ asset('public/vendors/plugins/datatables-buttons/css/buttons.bootstrap4.min.css') }}">
  <!-- Theme style -->
